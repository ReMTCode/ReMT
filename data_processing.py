...
def process_data(data_path, output_dir):
    ...
    # Translate questions to Spanish and generate esnewdata.csv
    ...
    # Translate questions to Italian and generate itnewdata.csv
    ...
    # Use OpenAI's gpt-3.5 API to improve the original questions and generate renewdata.csv
    prompt_template = (
    ...
    # Use another prompt to generate GAnewdata.csv
    prompt_ga = (
        "| CONTEXT |\n"
